import{t as A,r as v,C as S,_ as E,R as Y,S as Ce,F as J,l as b,n as ke,T as Ee,U as X,V as Z,W as Q,X as ee,Y as Re,Z as U}from"./vendor-firebase-eqIkjtCI.js";const te="@firebase/installations",N="0.6.21";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xe({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const a=se(e),i=le(e),r=t.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&i.append("x-firebase-client",l)}const s={fid:n,authVersion:ie,appId:e.appId,sdkVersion:ae},o={method:"POST",headers:i,body:JSON.stringify(s)},c=await ue(()=>fetch(a,o));if(c.ok){const l=await c.json();return{fid:l.fid||n,registrationStatus:2,refreshToken:l.refreshToken,authToken:oe(l.authToken)}}else throw await ce("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qe=/^[cdef][\w-]{21}$/,F="";function je(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=Ue(e);return qe.test(n)?n:F}catch{return F}}function Ue(e){return Le(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze="firebase-installations-database",He=1,y="firebase-installations-store";let _=null;function x(){return _||(_=Ce(ze,He,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(y)}}})),_}async function C(e,t){const n=R(e),i=(await x()).transaction(y,"readwrite"),r=i.objectStore(y),s=await r.get(n);return await r.put(t,n),await i.done,(!s||s.fid!==t.fid)&&pe(e,t.fid),t}async function he(e){const t=R(e),a=(await x()).transaction(y,"readwrite");await a.objectStore(y).delete(t),await a.done}async function P(e,t){const n=R(e),i=(await x()).transaction(y,"readwrite"),r=i.objectStore(y),s=await r.get(n),o=t(s);return o===void 0?await r.delete(n):await r.put(o,n),await i.done,o&&(!s||s.fid!==o.fid)&&pe(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ze({appConfig:e,heartbeatServiceProvider:t},n){const a=Qe(e,n),i=Oe(e,n),r=t.getImmediate({optional:!0});if(r){const l=await r.getHeartbeatsHeader();l&&i.append("x-firebase-client",l)}const s={installation:{sdkVersion:ae,appId:e.appId}},o={method:"POST",headers:i,body:JSON.stringify(s)},c=await ue(()=>fetch(a,o));if(c.ok){const l=await c.json();return oe(l)}else throw await ce("Generate Auth Token",c)}function Qe(e,{fid:t}){return`${se(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function st(e){const t=e,{installationEntry:n,registrationPromise:a}=await L(t);return a?a.catch(console.error):q(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ot(e,t=!1){const n=e;return await ct(n),(await q(n,t)).token}async function ct(e){const{registrationPromise:t}=await L(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k="analytics",gt="firebase_id",ht="origin",mt=60*1e3,wt="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",j="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let $;async function xt(e,t,n,a,i){if(i&&i.global){e("event",n,a);return}else{const r=await t,s={...a,send_to:r};e("event",n,s)}}async function Lt(e,t,n,a){if(a&&a.global)return e("set",{screen_name:n}),Promise.resolve();{const i=await t;e("config",i,{update:!0,screen_name:n})}}async function qt(e,t,n,a){if(a&&a.global)return e("set",{user_id:n}),Promise.resolve();{const i=await t;e("config",i,{update:!0,user_id:n})}}async function jt(e,t,n,a){if(a&&a.global){const i={};for(const r of Object.keys(n))i[`user_properties.${r}`]=n[r];return e("set",i),Promise.resolve()}else{const i=await t;e("config",i,{update:!0,user_properties:n})}}async function Ut(e,t){const n=await t;return new Promise((a,i)=>{e("get",n,"client_id",r=>{r||i(d.create("no-client-id")),a(r)})})}async function Bt(e,t){const n=await e;window[`ga-disable-${n}`]=!t}let O;function Ae(e){O=e}function ve(e){$=e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(t){this.app=t}_delete(){return delete p[this.app.options.appId],Promise.resolve()}}let p={},G=[];const z={};let T="dataLayer",Se="gtag",H,g,M=!1;function Qt(e){if(M)throw d.create("already-initialized");e.dataLayerName&&(T=e.dataLayerName),e.gtagName&&(Se=e.gtagName)}function Ht(){const e=[];if(X()&&e.push("This is a browser extension environment."),Z()||e.push("Cookies are not available."),e.length>0){const t=e.map((a,i)=>`(${i+1}) ${a}`).join(" "),n=d.create("invalid-analytics-context",{errorInfo:t});u.warn(n.message)}}function Kt(e,t,n){Ht();const a=e.options.appId;if(!a)throw d.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)u.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw d.create("no-api-key");if(p[a]!=null)throw d.create("already-exists",{id:a});if(!M){At(T);const{wrappedGtag:r,gtagCore:s}=kt(p,G,z,T,Se);g=r,H=s,M=!0}return p[a]=Gt(e,G,z,t,H,T,n),new zt(e)}function en(e=ke()){e=b(e);const t=E(e,k);return t.isInitialized()?t.getImmediate():Wt(e)}function Wt(e,t={}){const n=E(e,k);if(n.isInitialized()){const i=n.getImmediate();if(Ee(t,n.getOptions()))return i;throw d.create("already-initialized")}return n.initialize({options:t})}async function tn(){if(X()||!Z()||!Q())return!1;try{return await ee()}catch{return!1}}function nn(e,t,n){e=b(e),Lt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}async function an(e){return e=b(e),Ut(g,p[e.app.options.appId])}function rn(e,t,n){e=b(e),qt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function Yt(e,t,n){e=b(e),jt(g,p[e.app.options.appId],t,n).catch(a=>u.error(a))}function sn(e,t){e=b(e),Bt(p[e.app.options.appId],t).catch(n=>u.error(n))}function on(e){g?g("set",e):ve(e)}function Jt(e,t,n,a){e=b(e),xt(g,p[e.app.options.appId],t,n,a).catch(i=>u.error(i))}function cn(e){g?g("consent","update",e):Ae(e)}const K="@firebase/analytics",W="0.10.21";function Xt(){v(new S(k,(t,{options:n})=>{const a=t.getProvider("app").getImmediate(),i=t.getProvider("installations-internal").getImmediate();return Kt(a,i,n)},"PUBLIC")),v(new S("analytics-internal",e,"PRIVATE")),A(K,W),A(K,W,"esm2020");function e(t){try{const n=t.getProvider(k).getImmediate();return{logEvent:(a,i,r)=>Jt(n,a,i,r),setUserProperties:(a,i)=>Yt(n,a,i)}}catch(n){throw d.create("interop-component-reg-failed",{reason:n})}}}Xt();export{en as getAnalytics,an as getGoogleAnalyticsClientId,Wt as initializeAnalytics,tn as isSupported,Jt as logEvent,sn as setAnalyticsCollectionEnabled,cn as setConsent,nn as setCurrentScreen,on as setDefaultEventParameters,rn as setUserId,Yt as setUserProperties,Qt as settings};
