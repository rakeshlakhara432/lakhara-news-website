...
exports.sendLoginAlert = functions.https.onCall(async (data, context) => {
    ...
    const mailOptions = {
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        ...
        <p style="font-size: 16px; color: #333;">
          आपके लखारा डिजिटल न्यूज़ कम्युनिटी अकाउंट में अभी हाल ही में सफलतापूर्वक प्रवेश (Login) किया गया है।
        </p>
        <div style="background: #fdf2f2; padding: 20px; margin: 20px 0; border-radius: 8px;">
           <p style="margin: 5px 0; font-size: 14px;"><b>प्रवेश का तरीका (Login Method):</b> ${method}</p>
           <p style="margin: 5px 0; font-size: 14px;"><b>समय (Time):</b> ${new Date().toLocaleString("en-IN")}</p>
        </div>
        <p style="font-size: 14px; color: #666; font-weight: bold;">
          यदि यह प्रवेश आपने नहीं किया है, तो कृपया तुरंत अपना अकाउंट सुरक्षित करें और एडमिन से संपर्क करें।
        </p>
        <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;">
        <p style="font-size: 14px; color: #888; text-align: center;">
          ॥ जन जन की आवाज़, राष्ट्र का गौरव ॥ <br/>
          <b>LAKHARA DIGITAL NEWS SECURITY TEAM</b>
        </p>
      </div>
    `
    };
