...
import { getArticles, saveArticles, getCategories, Article } from "../../data/mockData";
...
export function CreateArticle() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newArticle: Article = {
      ...
      imageUrl: formData.imageUrl || "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=800",
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Upload a cover image for the article (max 2MB). Leave empty for default.</p>
          </div>
