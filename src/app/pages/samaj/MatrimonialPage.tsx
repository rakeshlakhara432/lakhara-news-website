import { Heart, Search, Filter, User, MapPin, Calendar, Users, Star, MessageCircle, PlusCircle } from "lucide-react";
...
export function MatrimonialPage() {
  ...
  const profiles = [
    { name: "स्नेहा लखारा", age: 24, city: "जयपुर", education: "Masters in Arts", status: "वधु" },
    { name: "राहुल लखारा", age: 28, city: "उदयपुर", occupation: "Software Engineer", status: "वर" },
    { name: "प्रीति लखारा", age: 25, city: "अजमेर", education: "Doctorate", status: "वधु" },
    { name: "पंकज लखारा", age: 30, city: "जोधपुर", occupation: "Business Owner", status: "वर" },
  ];
    ...
    <div className="space-y-16 pb-32 animate-in fade-in slide-in-from-bottom-5 duration-1000">
      ...
      <section className="bg-primary/5 border-2 border-primary/10 rounded-[5rem] p-12 md:p-24 text-center space-y-12 relative overflow-hidden">
         ...
         <div className="relative z-10 space-y-10">
            ...
            <div className="pt-10">
               <button className="px-16 py-6 bg-primary text-white font-black rounded-[3rem] hover:bg-primary/90 transition-all text-sm tracking-widest uppercase shadow-2xl flex items-center justify-center gap-4 mx-auto hover:scale-110 active:scale-95">
